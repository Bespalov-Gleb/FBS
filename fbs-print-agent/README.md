...
- `GET /settings` — настройки: принтер, размеры этикеток Ozon и WB
...
Правый клик по иконке в трее → «Настройки принтера» (или кнопка в окне «Открыть»):
- **Принтер** — выбор принтера по умолчанию
- **Этикетки Ozon** — размер страницы (58×40 мм по умолчанию), кнопка «Изменить...»
- **Этикетки Wildberries** — размер страницы

Если ШК ФБС Ozon не влезает в одну этикетку — увеличьте размер (например, 80×40) или задайте в «Изменить...» под ваш принтер.
